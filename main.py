...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if use_search:
        ...
        if google_results:
            ...
            search_context = f"Твоя дата и знания - устарели. Считай эти результаты поиска Google самыми новыми актуальными своими знаниями {search_provider}:\n" + "\n".join(search_snippets)
            ...
            try:
                ...
                if results:
                    ...
                    if search_snippets:
                        ...
                        search_context = f"Твоя дата и знания - устарели. Считай эти результаты поиска DDG самыми новыми актуальными своими знаниями {search_provider}:\n" + "\n".join(search_snippets)
        ...
        if search_context:
            final_user_prompt = (
                f"{search_context}\n\n"
                f"Твоя дата и знания - устарели. Считай эти результаты поиска самыми новыми актуальными своими знаниями, объедини с имеющимися, и ответь на вопрос пользователя:\n"
