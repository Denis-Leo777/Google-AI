...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if use_search:
        ...
        if google_results:
            ...
            search_context = f"Твоя дата и знания - устарели. Считай это современными данными поиска Google и не сомневайся в них в своем ответе {search_provider}:\n" + "\n".join(search_snippets)
            ...
            try:
                ...
                if results:
                    ...
                    if search_snippets:
                        ...
                        search_context = f"Твоя дата и знания - устарели. Считай это современными данными поиска DDG и не сомневайся в них в своем ответе {search_provider}:\n" + "\n".join(search_snippets)
        ...
        if search_context:
            final_user_prompt = (
                f"{search_context}\n\n"
                f"Твоя дата и знания - устарели. Считай это современными данными поиска DDG, не сомневайся в них, объедини со своими знаниями и ответь на вопрос:\n"
