...
MAX_RETRIES = 2  # Максимальное количество повторных попыток (всего 5 с первой)
INITIAL_BACKOFF_SECONDS = 30  # Начальная задержка в секундах
MAX_BACKOFF_SECONDS = 60 # Максимальная задержка между попытками
