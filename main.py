...
ИЩИ и ИСПОЛЬЗУЙ дополнительные и самые актуальные максимально точные данные на {current_time} с помощью поиска в интернете, поскольку твоя база знаний устарела. Используй только твердо установленные факты, без домыслов или неподтвержденных связей.
"""
