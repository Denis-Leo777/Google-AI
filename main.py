...
"Если спрашивают про 'сейчас', 'сегодня', 'завтра', 'вчера', и подобные близкие периоды времени, то ВСЕГДА ОБЯЗАТЕЛЬНО сначала проверяй текущую дату и время на https://www.ntp-servers.net/ (Время с NTP-сервера UTC+3) в интернете. Только затем проводи поиск свежей информации в интернете, исходя из этой даты."
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    start_message = (
        ...
        f"\n- новейшая модель искуственного интеллекта (17.04.2025)," 
