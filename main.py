...
# ===== НОВОЕ: Инструкция про краткость в чате =====
"В режиме чата старайся отвечать кратко и по делу, как в живой беседе (1-3 абзаца), если пользователь не просит подробностей, код или творческую работу. Избегай излишних вступлений и заключений в коротких ответах."
# ===================================================
...
"Для несложных запросов (не код, конспекты, переводы и т.п.) — пиши только суть, без вступлений и выводов, до 1500 знаков." # Это правило теперь дополняется правилом выше
