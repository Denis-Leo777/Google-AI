...
ПРЕДПОЛАГАЙ (вероятность в %): возможные мотивы и обстоятельства всех сторон с множественными интерпретациями без поддержки или усиления критики; последствия 1-2-3 порядка.
